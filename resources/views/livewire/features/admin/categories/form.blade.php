            ...
            <div class="p-6 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    <h3 class="text-2xl font-heading font-bold text-pop-dark">
                        {{ $category_id ? '✏️ Edit Kategori' : '➕ Tambah Kategori Baru' }}
                    </h3>
                ...
                <p class="text-gray-500 text-sm mt-1">Lengkapi informasi kategori produk Anda</p>
            </div>
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        <label for="name" class="block text-sm font-bold text-gray-700 mb-2">
                            Nama Kategori <span class="text-pop-primary">*</span>
                        </label>
                        <input type="text" id="name" wire:model.lazy="name"
                            placeholder="Contoh: Minuman Soda, Jus Buah, dll"
                    ...
                    <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                        ...
                        <label for="is_active"
                            ...
                            Kategori Aktif (Tampil di landing page)
                        </label>
                    </div>
                ...
                <div class="p-6 border-t border-gray-100 flex flex-col sm:flex-row gap-3 sm:justify-end">
                    ...
                    <button type="submit" wire:loading.attr="disabled"
                        ...
                        <i wire:loading.remove wire:target="store"
                            class="fa-solid {{ $category_id ? 'fa-pen-to-square' : 'fa-floppy-disk' }}"></i>
                        <span>{{ $category_id ? 'Update Kategori' : 'Simpan Kategori' }}</span>
                    </button>
                </div>
            </form>
