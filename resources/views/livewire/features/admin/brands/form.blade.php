    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ $brand_id ? 'Edit Brand' : 'Create New Brand' }}</h5>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="store">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" wire:model.lazy="name" placeholder="Enter brand name">
                        @error('name') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-3">
                        <label for="newImage" class="form-label">Brand Image</label>
