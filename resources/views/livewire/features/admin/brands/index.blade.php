    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl font-heading font-bold text-pop-dark mb-2">
                Brand <span class="text-pop-primary">Management</span>
            </h1>
            <p class="text-gray-600 text-lg">Kelola brand produk minuman Anda</p>
        </div>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm hover:shadow-xl transition-shadow duration-300 overflow-hidden">
            ...
            <div class="p-6 md:p-8 border-b border-gray-100">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h2 class="text-2xl font-heading font-bold text-pop-dark mb-1">Daftar Brand</h2>
                        <p class="text-gray-500 text-sm">Kelola semua brand produk Anda</p>
                    </div>
                        ...
                        <tbody>
                            @forelse ($brands as $index => $brand)
                                <tr
                                    ...
                                    <td class="py-4 px-4">
                                        <span
                                            class="font-semibold text-gray-700">{{ $brands->firstItem() + $index }}</span>
                                    </td>
                                    <td class="py-4 px-4">
                                        @if ($brand->image)
                                            <div
                                    ...
                                    <td class="py-4 px-4">
                                        <span class="font-bold text-pop-dark">{{ $brand->name }}</span>
                                    </td>
                                    <td class="py-4 px-4">
                                        <span
                                            class="text-gray-600 font-mono text-sm bg-gray-100 px-3 py-1 rounded-full">{{ $brand->slug }}</span>
                                    </td>
                                    <td class="py-4 px-4">
                                        @if ($brand->is_active)
                                            <span
                                ...
                                <tr>
                                    <td colspan="6" class="py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-gray-500 font-semibold">Belum ada brand</p>
