<div>
    {{-- Hero Section --}}
    <section id="categories-hero" class="pt-32 pb-12 md:pt-40 md:pb-16 bg-gradient-to-br from-pop-light to-white">
        <div class="container mx-auto px-6 text-center">
            ...
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-heading font-bold leading-tight text-pop-dark mb-6">
                Pilih <span class="text-pop-primary relative inline-block">
                    Kategori
            ...
            <p class="text-gray-600 text-lg max-w-2xl mx-auto mb-8">
                Dari soda segar hingga jus buah alami, temukan kategori minuman yang sesuai dengan suasana hatimu hari
                ini.
            </p>
        </div>
    </section>
    ...
    <section id="all-categories" class="py-16 bg-white">
        <div class="container mx-auto px-6">
            ...
            @else
                <div class="text-center py-20">
                    ...
                    <p class="text-gray-500 text-xl">Belum ada kategori yang tersedia saat ini.</p>
                </div>
            @endif
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div class="flex flex-col items-center">
                    <i class="fa-solid fa-layer-group text-5xl mb-4 text-pop-secondary"></i>
                    <h3 class="text-4xl font-black mb-2">{{ $categories->count() }}+</h3>
                    <p class="text-white/90 font-medium">Kategori Minuman</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa-solid fa-bottle-water text-5xl mb-4 text-pop-secondary"></i>
                    <h3 class="text-4xl font-black mb-2">{{ $categories->sum('products_count') }}+</h3>
                    <p class="text-white/90 font-medium">Total Produk</p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="fa-solid fa-face-smile text-5xl mb-4 text-pop-secondary"></i>
                    <h3 class="text-4xl font-black mb-2">100%</h3>
                    <p class="text-white/90 font-medium">Kepuasan Pelanggan</p>
                </div>
            </div>
        </div>
    </section>
